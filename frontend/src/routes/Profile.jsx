...
const Profile = () => {
    // const { user, profile, isFollower, posts } = useOutletContext;
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            setProfile(dataFromServer.profile)
            setIsFollower(dataFromServer.isFollower)
    ...
    console.log(user,profile,isFollower,posts)
